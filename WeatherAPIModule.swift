...
/*        let url = URL(string: "http://api.weatherapi.com/v1/current.json?key=f826a4ae7cab467981a192902220204&q=" + "Durham" + ", " + "NC" + ", " + "USA" + "&aqi=no")!*/
        ...
        do {
            ...
            //print(weather_apicall.forecast)
            
            print("Today's weather: \(weather_apicall.forecast.forecastday[0].day.avgtempF)")
            
            //call method to filter through weather_apicall and return data.
